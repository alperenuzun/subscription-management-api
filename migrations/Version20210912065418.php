...
final class Version20210912065418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE device (id INT AUTO_INCREMENT NOT NULL, uid VARCHAR(32) NOT NULL, language VARCHAR(3) NOT NULL, operating_system VARCHAR(10) NOT NULL, INDEX IDX_uid (uid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, status SMALLINT NOT NULL, expire_date DATE DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_A3C664D319EB6921 (client_id), INDEX IDX_status (status), INDEX IDX_expire_date (expire_date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
